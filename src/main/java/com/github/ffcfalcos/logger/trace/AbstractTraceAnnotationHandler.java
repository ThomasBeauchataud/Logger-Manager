...
public abstract class AbstractTraceAnnotationHandler {
    ...
    protected void handleTraceBefore(JoinPoint joinPoint, TraceBefore traceBefore) {
        ...
        logger.log(logContent.close(Severity.DEBUG), traceBefore.persistingHandlerClass(), traceBefore.formatterHandlerClass());
    }
    ...
    protected void handleTraceAfter(JoinPoint joinPoint, TraceAfter traceAfter) {
        ...
        logger.log(logContent.close(Severity.DEBUG), traceAfter.persistingHandlerClass(), traceAfter.formatterHandlerClass());
    }
    ...
    protected void handleTraceAfterThrowing(JoinPoint joinPoint, Exception exception, TraceAfterThrowing traceAfterThrowing) {
        ...
        logger.log(logContent.close(Severity.DEBUG), traceAfterThrowing.persistingHandlerClass(), traceAfterThrowing.formatterHandlerClass());
    }
    ...
    protected void handleTraceAfterReturning(JoinPoint joinPoint, Object output, TraceAfterReturning traceAfterReturning) {
        ...
        logger.log(logContent.close(Severity.DEBUG), traceAfterReturning.persistingHandlerClass(), traceAfterReturning.formatterHandlerClass());
    }
